const contentLetterSrart_actived = "Gửi bé Me! Hôm nay anh không đón sinh nhật cùng em bé của anh được nên tặng bé món quà nhỏ này trước nhá <3 Nhấn vào Hộp quà => Trái tim => Lá thư nha bảo bối" //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc công chúa của anh sanh thần vui vẻ! Chúc em bé luôn luôn xinh đẹp, khỏe mạnh, học ngày càng giỏi, ra trường đúng hạn và để anh cùng em hoàn thành ước mơ nháa vại tương lơ <3 \n Anh yêu em. \t    Khánh Duy" //Nội dung của bức thư
...
imgLetter.src = "./img/baby.jpg"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
...
function createLight(a) {
    ...
    const blurLv = [2, 4];
    const count = a;
    const allDefaultColor = ["red", "lime", "yellow", "orange", "blue", "green", "purple", "pink", "white"]
...
document.querySelector('.box-body').addEventListener('click', function() {
  ...
  document.querySelector('.letterForm').addEventListener('click', function() {
